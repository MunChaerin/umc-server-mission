...
public class MissionController {
    ...
    public ApiResponse<MissionResDTO.MissionPreviewDTO> createMission(@ExistStores @RequestBody MissionReqDTO.CreateMissionDTO dto){
    ...
    private ApiResponse<MissionResDTO.MissionPreviewDTO> updateMissionStatus(@PathVariable Long missionId,
                                                                             @Valid@ExistStores@AlreadyChallenging@RequestBody MissionReqDTO.ChallengingMissionDTO dto){
