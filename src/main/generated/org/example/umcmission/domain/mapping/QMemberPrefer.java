...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    private static final long serialVersionUID = 2016799925L;
    ...
    public final org.example.umcmission.domain.QFoodCategory foodCategory;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new org.example.umcmission.domain.QFoodCategory(forProperty("foodCategory")) : null;
